...
/**
 * \file    htdocs/custom/ophelia/class/strategy.class.php
 * \ingroup ophelia
 * \brief   CRUD class for OpheliaStrategy
 */

require_once DOL_DOCUMENT_ROOT.'/core/class/commonobject.class.php';

/**
 * Class for Ophelia extraction strategy
 */
class OpheliaStrategy extends CommonObject
{
	public $module = 'ophelia';
	public $element = 'opheliastrategy';
	public $table_element = 'ophelia_strategy';
	...
	public $fields = array(
		...
		'priority' => array('type' => 'integer', 'label' => 'Priority', 'enabled' => 1, 'position' => 40, 'notnull' => 1, 'visible' => 1, 'default' => 0),
		'active' => array('type' => 'integer', 'label' => 'Active', 'enabled' => 1, 'position' => 50, 'notnull' => 1, 'visible' => 1, 'default' => 1, 'index' => 1),
		'params_json' => array('type' => 'text', 'label' => 'ParamsJson', 'enabled' => 1, 'position' => 60, 'notnull' => 0, 'visible' => 0),
	);
	 ...
	 */
	public function fetchAll($sortorder = 'ASC', $sortfield = 't.priority', $limit = 1000, $offset = 0, $filter = '')
	{
		$records = array();
